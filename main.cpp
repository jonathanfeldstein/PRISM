...
{
    HyperGraph hg = HyperGraph("/home/dominic/CLionProjects/FASTER/Databases/unconnected_hypergraph_test.db",
                               "/home/dominic/CLionProjects/FASTER/Databases/unconnected_hypergraph_test.info",
                               false);

    vector<set<NodeId>> hgs = hg.find_unconnected_components();
    vector<HyperGraph> constructed_hypergraphs;
    for(auto component:hgs){
        HyperGraph subgraph(component, hg);
